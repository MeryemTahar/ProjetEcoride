...
$added = $paymentModel->addPayment(8, 2, 50.00, 'card');
if ($added) {
...
$payment = $paymentModel->getPaymentById(8);
if ($payment) {
...
$updated = $paymentModel->updatePaymentStatus(18, 'completed');
if ($updated) {
...
$deleted = $paymentModel->deletePayment(19);
if ($deleted) {
